// /routes/coverRoutes.js

const express = require('express');
const path = require('path');
const {getImageNameByAlbumId} = require('../services/imageService'); // Adjust the path as needed
...
router.get('/:albumId', (req, res) => {
  ...
  const imageName = getImageNameByAlbumId(albumId);
  ...
  const imagePath = path.join(__dirname, '..', 'public', 'images', 'Covers', imageName);
